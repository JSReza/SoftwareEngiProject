...
import edu.softwareeng.sample.DataStoreReadResult.Status;
...
public class DataStorePrototype {
	...
	public void prototype(DataStore apiToCall) {
		...
		DataStoreReadResult dataStoreReadResult = apiToCall.read(inputConfig);
		
		// This is an example of a not-very-fancy enum
		if (dataStoreReadResult.getStatus() == Status.SUCCESS) {
